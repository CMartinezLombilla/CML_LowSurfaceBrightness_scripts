...
# Cargamos la mascara
# =============================================================================
mask = fits.getdata(masks_path+mask_file)
...
for band in bands:
    ...
    if member == 'BCG_sky': # No aplicamos la correcion si lo estamos haciendo para el cielo 
        SkyCorr[band] = 0 
        
    data = fits.getdata(results_path+'PSFcorr-'+band+'.fits')-SkyCorr[band]
