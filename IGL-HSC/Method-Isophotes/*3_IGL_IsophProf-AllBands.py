...
for structure in ['IGL', 'group']:
    ...
    for index, band in enumerate(bands): 
        ...
        files = {'IGL':results_path+'Isophotes/IGL/profiles_isoph/IGL_sbp_'+band+'.fits',
                 'group': results_path+'Isophotes/IGL/profiles_isoph/group_sbp_'+band+'.fits'}
...
plt.savefig(results_path+'Isophotes/IGL/profiles_isoph/Group-and-IGL_prof-AllBands.pdf')
