...
try:
    ...
    os.mkdir(results_path+'Isophotes/IGL/color')
except:
    pass

try:
    # Create target Directory
    os.mkdir(results_path+'Isophotes/IGL/color/profiles')
except:
    pass
...
colors = ['r-i']#'g-i', 'g-r','r-i']
plot_col = ['C0', 'C1', 'C2']

files = {'g-i':[results_path+'Isophotes/IGL/profiles_isoph/IGL_sbp_g.fits', results_path+'Isophotes/IGL/profiles_isoph/IGL_sbp_i.fits'],
         'g-r':[results_path+'Isophotes/IGL/profiles_isoph/IGL_sbp_g.fits', results_path+'Isophotes/IGL/profiles_isoph/IGL_sbp_r.fits'], 
         'r-i':[results_path+'Isophotes/IGL/profiles_isoph/IGL_sbp_r.fits', results_path+'Isophotes/IGL/profiles_isoph/IGL_sbp_i.fits']}
...
for ind, color in enumerate(colors):    
    ...
    table.write(results_path+'Isophotes/IGL/color/profiles/'+file_name, overwrite=True)
...
files = {'g-i':[results_path+'Isophotes/IGL/profiles_isoph/group_sbp_g.fits', results_path+'Isophotes/IGL/profiles_isoph/group_sbp_i.fits'],
         'g-r':[results_path+'Isophotes/IGL/profiles_isoph/group_sbp_g.fits', results_path+'Isophotes/IGL/profiles_isoph/group_sbp_r.fits'], 
         'r-i':[results_path+'Isophotes/IGL/profiles_isoph/group_sbp_r.fits', results_path+'Isophotes/IGL/profiles_isoph/group_sbp_i.fits']}
...
for ind, color in enumerate(colors):    
    ...
    ax.set_xlabel("Isophote as in fits image")
    ax.set_ylabel('Color')
...
plt.savefig(results_path+'Isophotes/IGL/color/profiles/group-and-IGL_ColorProf.pdf')
