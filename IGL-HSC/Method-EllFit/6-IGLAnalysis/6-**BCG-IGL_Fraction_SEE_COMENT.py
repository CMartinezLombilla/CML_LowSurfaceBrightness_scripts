...
EDITAR PATHS PARA QUE COJE LAS IMAGENES CORRECTAS CUANDO LO USE 
(AUN NO LO HE USADO PORQUE EL METODO DE LAS DISTANCIAS ME FUNCIONO MEJOR)


EN ESTA CASO:

0. EL FLUJO TOTAL SE CALCULA IGUAL

1. HABRIA QUE CARGAR LA IMAGEN DEL GRUPO ENMASCARADO TODO MENOS LA BCG PARA 
CALCULAR LA CANTIDAD DE BCG+IGL. SERIA PROBABLEMENTE LA MISMA QUE USO PARA 
ESTIMAR EL CIELO EN BCGSKY
...
IGL_SB_sum = {'Name':'BCG+IGL_SB_sum','g':0, 'r':0, 'i':0}
IGL_SB_sum_err = {'Name':'BCG+IGL_SB_sum_err','g':0, 'r':0, 'i':0}
IGLfrac_SB  = {'Name':'BCG+IGLfrac_SB','g':0, 'r':0, 'i':0}
IGLfrac_SB_err  = {'Name':'BCG+IGLfrac_SB','g':0, 'r':0, 'i':0}
...
pdf = PdfPages(results_path+'IGL/BCG-IGLfraction/All_appertures.pdf')
...
# pdf file to save the plots
pdf = PdfPages(results_path+'IGL/BCG-IGLfraction/BCG-IGL-2DMod_ap'+str(maxsma['Core'])+'pix.pdf')
...
table = Table(rows=table_vec, meta={'BCG+IGL amount and fraction': 'table info'})
table.write(results_path+'IGL/BCG-IGLfraction/BCG-IGLfrac_table.fits', overwrite=True)
