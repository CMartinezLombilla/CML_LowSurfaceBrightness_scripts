...
# Plot
plt.errorbar(mean_IGLcolor_g_r, mean_IGLcolor_r_i, xerr=mean_IGLerr_g_r, yerr=mean_IGLerr_r_i, marker='X', markersize=10, linestyle='None', color='k', zorder=3, alpha = 0.9, label='IGL')
plt.errorbar(mean_GALcolor_g_r, mean_GALcolor_r_i, xerr=mean_GALerr_g_r, yerr=mean_GALerr_r_i, marker='X',linestyle='None', markersize=10, color='y', zorder=3, alpha = 0.9, label='Group')
