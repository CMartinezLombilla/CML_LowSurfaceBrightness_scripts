...
# Initial params
# =============================================================================
sims = ['2Mpc']#Horizon_AGN', 'Hydrangea', 'Magneticum', 'TNG_100'] 
clust_ids = {'2Mpc':['048', '213', '114', '006']}
    ...
    for cluster in clusters:
        for orientation in orientations:
            ...
            for ind, sblim in enumerate(sb_IGLlim_list): # correcting by sbdimming & k-corr
                ...
                #save_fits_image(data_IGL_ii, hdr, icl_path, 'IGLfrac-SBlim-'+str(sblim)+'.fits')
            ...
            table_IGL.write(icl_path+'IGLfrac_sbcut_table.fits', overwrite=True)
