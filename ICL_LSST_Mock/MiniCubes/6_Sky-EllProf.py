...
data, hdr = fits.getdata(results_path+'Images/2Mpc_048_xy_r_2Mpc_bin2_x1e+12.fits', header = True) 
...
ct_prof = dist_ellipse_prof(data, dist_map, sma0, step, nbins, 0, zp, pixscale, A=0, dimming=0, k_corr=0)
